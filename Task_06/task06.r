...
The freq allele change in subset has a higher range in the birth subset than the survival subset. This is due to the fact that survivors and immigrants do not really effect the change in allele frequency as much as reproduction does. The graph shows that even when there is overall freq change, the survivors allele change in subset does not change. This is due because deaths and immigration is random but the births change more becasue of mendelian genetics. 
